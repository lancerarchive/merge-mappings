...
# \*\*GeyserMerger\*\* is a high-performance web utility designed to solve the headache of merging multiple GeyserMC model mapping files. It ensures your `custom\_model\_data` remains unique, sorted, and conflict-free with a modern, glassmorphic interface.
...
# \* \*\*Conflict Prevention:\*\* Detects existing `custom\_model\_data` IDs in your primary file and skips duplicates from the secondary file to prevent Bedrock-side crashes.
